...
def create_50page_masterpiece():
    ...
    chapters = [
        ("PHẦN 1: TỔNG QUAN HỆ SINH THÁI WEBSITE PC MASTER LMS & BẢNG ĐỐI CHIẾU TIÊU CHÍ PHỤ LỤC 4", 5),
        ("PHẦN 2: THỰC TRẠNG GIÁO DỤC, MỤC TIÊU & TÍNH SÁNG TẠO ĐỘC ĐÁO (III.1 - 15 ĐIỂM)", 5),
        ("PHẦN 3: NĂNG LỰC TỔ CHỨC THỰC HIỆN & KẾ HOẠCH PHÁT TRIỂN (III.2 - 15 ĐIỂM)", 6),
        ...
        ("PHẦN 9: KỊCH BẢN THUYẾT TRÌNH & PHẢN BIỆN TẠI GIAN HÀNG (II.1, II.2 - 20 ĐIỂM)", 5),
        ("PHẦN 10: CHƯƠNG TRÌNH KHÓA HỌC CAREER BUILD & NGÂN HÀNG BÀI GIẢNG 3D INTERACTIVE", 5),
        ("PHẦN 11: BẢNG DÀN DỰNG CHI TIẾT 12 SLIDE PITCH DECK HUIT STARTUP 2026", 4),
        ("PHẦN 12: HƯỚNG DẪN KỸ THUẬT VẬN HÀNH & HỆ THỐNG MÃ NGUỒN CỐT LÕI", 4),
        ("PHẦN 13: BỘ SỐ LIỆU ĐẢM BẢO TÍNH KHẢ THI VÀ AN TOÀN BẢO MẬT HỌC ĐƯỜNG", 4),
        ("PHẦN 14: KẾ HOẠCH MỞ RỘNG VÀ HỢP TÁC DOANH NGHIỆP BÁN LẺ LINH KIỆN", 4),
    ...
    for chap_title, num_pages in chapters:
        ...
        # Insert structured text and tables
    ...
    doc.save(filename)
    print(f"Masterpiece docx generated: {filename}")

if __name__ == "__main__":
    create_50page_masterpiece()
