...
export function NotificationBell({ userId, filterTypes }: { userId?: string, filterTypes?: string[] }) {
  const [isOpen, setIsOpen] = useState(false)
  const { notifications, unreadCount, markAsRead, markAllAsRead } = useNotifications(userId, { filterTypes })
