...
export default function HeadTracker() {
  ...
  const drawFaceMesh = useCallback(
    (landmarks: { x: number; y: number; z: number }[]) => {
      ...
      const FACE_CONNECTIONS: [number, number][] = [
        [10, 338], [338, 297], [297, 332], [332, 284], [284, 251], [251, 389], [389, 356], [356, 454], [454, 323], [323, 361], [361, 288], [288, 397], [397, 365], [365, 379], [379, 378], [378, 400], [400, 377], [377, 152], [152, 148], [148, 176], [176, 149], [149, 150], [150, 136], [136, 172], [172, 58], [58, 132], [132, 93], [93, 234], [234, 127], [127, 162], [162, 21], [21, 54], [54, 103], [103, 67], [67, 109], [109, 10], [10, 338], [46, 53], [53, 52], [52, 65], [65, 55], [55, 285], [285, 295], [295, 282], [282, 283], [283, 276], [276, 352], [352, 346], [346, 340], [340, 330], [330, 329], [329, 450], [450, 449], [449, 448], [448, 261], [261, 446], [446, 342], [342, 445], [445, 444], [444, 443], [443, 442], [442, 441], [441, 413], [413, 414], [414, 372], [372, 383], [383, 300], [300, 301], [301, 263], [263, 466], [466, 388], [388, 387], [387, 386], [386, 385], [385, 384], [384, 398], [398, 362], [362, 382], [382, 381], [381, 380], [380, 374], [374, 373], [373, 390], [390, 249], [249, 64], [64, 98], [98, 97], [97, 96], [96, 95], [95, 94], [94, 93], [93, 132], [116, 163], [163, 123], [123, 143], [143, 155], [155, 154], [154, 157], [157, 158], [158, 159], [159, 160], [160, 161], [161, 243], [243, 173], [173, 133], [133, 245], [245, 244], [244, 246], [246, 247], [247, 248], [248, 249], [33, 246], [246, 161], [161, 160], [160, 159], [159, 158], [158, 157], [157, 173], [173, 133], [133, 155], [155, 154], [154, 153], [153, 145], [145, 144], [144, 163], [163, 116], [168, 9], [9, 8], [8, 168], [168, 6], [6, 197], [197, 195], [195, 5], [5, 4], [4, 1], [1, 19], [19, 20], [20, 24], [24, 4], [4, 5], [5, 195], [197, 6], [6, 168], [168, 8], [8, 9],
      ];
      ...
      try {
        ...
        if (results.faceLandmarks && results.faceLandmarks.length > 0) {
          ...
          if (nose && leftEye && rightEye && mouth) {
            ...
            headTrackingRef.pitch = pitch;
            headTrackingRef.yaw = yaw;

            setCameraCoords({ pitch, yaw, roll: 0 });
  ...
  const displayPitch = (headTrackingRef.pitch * 100).toFixed(0);
  const displayYaw = (headTrackingRef.yaw * 100).toFixed(0);
    ...
    >
      ...
      {status === 'active' && (
        <>
          ...
          >
            <span>P: {displayPitch}</span>
            <span>Y: {displayYaw}</span>
          </div>
        </>
      )}
